def check_number():
        ...
        for i in range(3):
            if Secret_Number_list.count(Secret_Number[i])==1:
                ...
                return False
import random
Secret_Number=input('The number you want conputer to guess:')
while True:
...
if Correct_Digits=='0':
    ...
    if Correct_Digits=='1':
        ...
        if Correct_Digits=='0':
            ...
            Exact_Digits=input('How many exact digits?')
            if Correct_Digits=='0':
                Guess_Number_5=Number_list_1[2]+Number_list_1[3]+Number_list_2[2]
                print('Guess 5:',Guess_Number_5)
                Correct_Digits=input('How many correct digits?')
                Exact_Digits=input('How many exact digits?')
                if Correct_Digits=='1' and Exact_Digits=='0':
                    Guess_Number_6=Number_list_1[4]+Number_list_2[2]+Number_list_1[5]
                    print('Guess 6:',Guess_Number_6)
                    Correct_Digits=input('How many correct digits?')
                    Exact_Digits=input('How many exact digits?')
                    if Correct_Digits=='2' and Exact_Digits=='0':
                        Guess_Number_7=Number_list_2[2]+Number_list_1[4]+Number_list_1[6]
                        print('Guess 7:',Guess_Number_7)
                        Correct_Digits=input('How many correct digits?')
                        Exact_Digits=input('How many exact digits?')
                        if Correct_Digits=='3' and Exact_Digits=='1':
                            Guess_Number_8=Number_list_2[2]+Number_list_1[6]+Number_list_1[5]
                            print('Guess 8:',Guess_Number_8)
                            Correct_Digits=input('How many correct digits?')
                            Exact_Digits=input('How many exact digits?')
                            print('Yes!It is the Number!',Guess_Number_8)
                        elif Correct_Digits=='3' and Exact_Digits=='3':
                            print('Yes!It is the Number!',Guess_Number_7)
